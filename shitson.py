...
N_Cls = 10
DF = pd.read_csv('inputs/train_wkt_v4.csv')
GS = pd.read_csv('inputs/grid_sizes.csv', names=['ImageId', 'Xmax', 'Ymin'], skiprows=1)
SB = pd.read_csv('inputs/sample_submission.csv')
ISZ = 160
smooth = 1e-12
...
def M(image_id):
    ...
    img = tiff.imread('inputs/sixteen_band/{}_M.tif'.format(image_id))
